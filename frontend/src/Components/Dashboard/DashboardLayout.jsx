...
const DashboardLayout = ({ children }) => {
  ...
  const getSidebarItems = () => {
    ...
    // For patients, show minimal options
    ...
    // For admin/staff roles, show full dashboard
    const allItems = [
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Sidebar - Only show for non-patient users */}
      {!isPatient && (
        <aside
          className={`${
        ...
        >
          <div className="flex flex-col h-full">
            {/* Sidebar header - Only show for non-patient users */}
            {!isPatient && (
      ...
      {/* Main content */}
      <div className={`flex flex-col flex-1 overflow-y-auto ${isPatient ? '' : 'lg:ml-0'}`}>
        {/* Top header - Only show for non-patient users */}
        {!isPatient && (
